...
export class CsvService {
	...
	[Upgrades Move] |Swift Boots| +2 Move - You cannot use heals on the map.,{Gold:5}
	...
	[Upgrades Attack/Prepare] |Flaming Sword| +1 Melee Attack - When you roll one or more {Dice:!} while Melee Attacking you may inflict Burn.,{Gold:4}
	...
	[Upgrades Craft/Mine] |Pickaxe| +1 Mine. When you roll 1 or more {Dice:!} you may spend one of them to gain {Gem:R}.,{Gold:5}
	...
	[Upgrades Move] +1 Move. +1 Use. Once per turn: you may Stun yourself to take an additional action. This additional action must be a Move or a Use. You may use this card as though it were a Use action card.,{Gold:10}
	[Upgrades Melee Attack/Prepare] | Poison Dagger | +1 Prepare. You may pay {Gem:R} when you Attack to inflict poison instead of damage. (Decide before rolling dice.),{Gold:7}
	[Passive] |Meditation Stance| +1 Prepare. When you roll one or more {Dice:Miss} you may reroll 1 die.,{Gold: 4}
	[Upgrades Discover/Use] |Dangerous Chemicals| When you roll two or more {Dice:!} in a single roll during your turn - you may take a Use action using this card after finishing that action.,{Gold:5}`;
