...
export class CsvService {
	...
	private castToActionsArray(glob: string): any {
		...
		if (glob) {
			...
			rows.forEach((row) => {
				...
				let rules = row.split(']')[row.split(']').length - 1]; // returns everything after any []
	...
	[Passive] |Liquid Shield|+1 Armor - When an opponent rolls one or more {Dice:Crit} while attacking you - you may spend {Gem:R} to turn one into {Dice:Miss},{Gold:4}
	[Passive] |Spike Armor|  +1 Armor. When you roll one or more {Dice:!} - Deal 1 damage to an enemy within range 1.,{Gold:6}
	[Passive] |Anklets of The Wind| +1 Move - When you roll one or more {Dice:!} you may use it to Move 1,{Gold:3}
	[Passive] |Sure-Footed Greaves| +1 Move. When you roll {Dice:!} you may spend one to put a +1 Counter on one of your Action Cards.,{Gold:4}
	[Replaces Move] |Swift Boots| +2 Move - You cannot use heals on the map.,{Gold:5}
	[Passive] |Silver Coating| +1 Melee Attack. Deal 1 extra damage whenever you Attack a monster.,{Gold:3}
	...
	[Replaces Move] |Zagreus Feet| You are immune to lava. When you roll one or more {Dice:!} you may spend one to inflict Burn on an enemy within range 1.,{Gold:3}
	...
	[Replaces Ranged Attack/Trade] |Explosive Arrows| +1 Ranged Attack. When you roll one or more {Dice:!} you may ignore all {Dice:Miss} this roll. You may spend {Gem:R} to inflict 2 additional damage to your target and all adjacent targets.,{Gold:7}
	[Passive] |Saltpeter| Your damage dealing consumeable items deal +2.,{Gold:4}
	[Replaces Ranged Attack/Trade] |Strongbow| +1 Ranged Attack - When you use this action to roll one or more {Dice:!} and no {Dice:Miss} you may spend {Gem:R} to inflict Stun.,{Gold:5}
	[Passive] |Toxic Oil| +1 Melee Attack - Inflict {Dice:!} Poison to your target when you roll dice to attack.,{Gold:6}
	[Replaces Attack/Prepare] |Flaming Sword| +1 Melee Attack - When you roll one or more {Dice:!} while Melee Attacking you may inflict Burn.,{Gold:4}
	[Passive] |Scavenging| +1 Discover and +1 Use.,{Gold:6}
	[Passive] |Acrobatics| You may use any Slot Level 4+ Action Card as though it was any of your other Action Cards. If you do: Treat it as Slot Level 2. (This does benefit from +1 Action Name effects.),{Gold:4}
	[Passive] |Vampire Fangs| +1 Melee Attack - When you roll {Dice:!} you may spend any number to heal 1 for each.,{Gold:5}
	[Replaces Move] |Running Shoes|  +2 Move. Mountains cost you 3 movement points to step onto. (Instead of 2.),{Gold:2}
	[Passive] |Sniper Sight| +2 Ranged Attack. -1 Melee Attack. You may reroll up to 2 dice when you Ranged Attack. (This can reroll the same die twice.),{Gold:5}
	[Passive] |Heavy Club| +1 Melee Attack - When you roll {Dice:!} while attacking you may spend them as Move controlling your target. They must be further away from you after each move. (Follow Terrain rules.),{Gold:5}
	[Passive] |Backpack| +1 Use. May carry two extra Consumable items. (Capacity increased from 3 to 5.),{Gold:3}
	...
	[Replaces Move] |Wings| You may ignore all terrain. (This allows you to walk on Water\traverse Mountains freely\and take no damage from Lava.),{Gold:3}
	...
	[Replaces Discover/Use] |Robotic Arm| When you take the Use action you may repeat it once at the same Slot Level.,{Gold:8}
	[Replaces Melee Attack/Prepare] |Glass Spear| Stun. +2 Slot Level if used in Slot Level 4. Fragile (Item is returned to reserve after each use.),{Gold:2}
	...
	[Replaces Discover/Use] | Quick-Access Belt | When Crafted: you may pay {Gem:R}. If you do\draw 2 cards from the Consumable deck and keep them. +2 Use. Play with your Consumable cards revealed.,{Gold:6}
	...
	[Passive] |Meditation Stance| +1 Prepare. When you roll one or more {Dice:Miss} you may reroll 1 die.,{Gold: 4}
	[Replaces Discover/Use] |Dangerous Chemicals| When you roll two or more {Dice:!} in a single roll during your turn - you may take a Use action using this card after finishing that action.,{Gold:5}`;

	localUsablesCsv = `Text,Slot,
	[Oneuse] | Instant Transmission | Choose a hex within Range 3. Teleport to that hex. Then you may take another action., {Slot:1}
	...
	[Oneuse] | Remote Mining | Use all Mines within Slot Level range. For each: Roll 2 dice and gain a {Gold:} per {Dice:Hit} and a gem per {Dice:!}.,
	[Oneuse] | Springboard | Choose a space within range 5. Teleport to that space.,{Slot:2}
	[Oneuse] | Attune with Nature | Explore any number of adjacent tiles. Use all Gem and Health rewards on those tiles., {Slot:3}
	...
	[Oneuse] | Full Restore | Fully Heal and remove all Status Effects., {Slot:4}
	...
	[Oneuse] | Bottled Lightning | Hit all adjacent hexes. Damage equals Slot Level + 2.,
	[Oneuse] | Cannon Shot | Range 5 deal 5 damage to one target., {Slot:4}
	...
	[Oneuse] | Magic Missile | 5 range. Deal Slot Level damage.,
	[Oneuse] | Napalm | 5 range inflict Burn and Daze., {Slot: 3}
	[Oneuse] | Power Potion | Immediately take another action. It's Slot Level is increased by 2., {Slot:3}
	[Oneuse] | Power Potion | Immediately take another action. It's Slot Level is increased by 2., {Slot:3}
	...
	[Oneuse] | Blast Mining | Gain Slot Level x2 {Gold:}.,
	...
	[Oneuse] | Mortar and Pestle | Spend up to Slot Level gems. For each do one of the following and you may choose the same option more than once. Move 2. Attack 2. Draw a Consumable card.
	[Oneuse] | Poison Vial | Your next attack this turn inflicts poison instead of damage. Then you may take an Attack action., {Slot:3}
	...
	[Immediate] | Trade Contact | Buy any number of {Gem:R} for {Gold:} each.
	[Immediate] | Coins | Gain 3 {Gold:},
	[Immediate] | Coins | Gain 3 {Gold:},
	[Immediate] | Coins | Gain 3 {Gold:},
	...
	[Immediate] | Gambler's Dice | Roll 3 dice. On 3+ {Dice:Hit} gain 5 {Gold:}.,
